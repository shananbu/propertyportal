...
<main class="main_wrapper clr_fix pro_view_top">
      ...
      <div class="row_main">
        <ul>
          <li> <i class="fa fa-map-marker"></i>
            <p> Address <span> At Porur, Chennai West </span> </p>
          </li>
 ...
 <%-- <section class="sec_view_4 sec_view_block" id="trends">
    <div class="row_main">
      <h1><span>Trends</span></h1>
      <div class="clr_fix unit_details">
        <div class="gallery_left clr_fix">
          <canvas id="canvas"></canvas>
          <div class="chart_info"> <span class="name_1"> name - 1</span> <span class="name_2"> name - 2</span> </div>
        </div>
        <aside class="unit_right">
          <h3 class="h_1">New projects</h3>
          <div class="box_shadow clr_fix form_fil_1">
...
<%--  <section class="sec_view_6 sec_view_block">
    <div class="row_main">
      <h1><span>bank approvals</span></h1>
