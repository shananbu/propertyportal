...
(function ($) {
    ...
    function removeRow(tbWhole, rowIndex, uniqueIndex, force) {
        ...
        if ($.isNumeric(rowIndex)) {
            // Remove middle row
            if ((force || typeof (settings.beforeRowRemove) != 'function' || settings.beforeRowRemove(tbWhole, rowIndex)) && settings._rowOrder.length > 1) {
            ...
            // Remove last row
            if ((force || !$.isFunction(settings.beforeRowRemove) || settings.beforeRowRemove(tbWhole, settings._rowOrder.length - 1)) && settings._rowOrder.length > 1) {
