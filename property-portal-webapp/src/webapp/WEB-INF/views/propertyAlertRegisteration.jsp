        ...
        <section class="col_4 clr_fix">
            ...
            <section class="inner_wrapper">
                ...
                <div class="user_register post_buy_pro jq_chk">
                    <ul>
                        <li>
                            <label>I want to<small>*</small></label>
                <span>
                ...
                Rent </span> </li>
                        ...
                        <li>
                            <label>Bedrooms <small>*</small></label>
                        ...
                        <li class="area_input">
                            <label>Covered/Built-up Area<small>*</small></label>
                            <input type="text">
                            To
                            <input type="text">
                            <select class="dropdown">
                        ...
                        <li class="buget_input">
                            <label>Budget<small>*</small></label>
                            <input type="text"> To
                            <input type="text">
                        </li>
                        <li>
                        ...
                        <li class="spam_input">
                            <label> Spam Check <small>*</small></label>
                            6 - 2 =
                            <input type="text">
                            <span>Please answer this simple math question</span> </li>
                        <li class="log_face">
                            <label>I am<small>*</small></label>
                <span>
                ...
                New User </span> </li>
                        <li>
                            <label>Username / Email id<small>*</small></label>
                            <input type="text">
                        </li>
...
<div class="forget_pop">
    <div class="pop_wrapper">
        ...
        <div class="for_para">
            <p>
                Enter the username or email id you provided when you registered on Magicbricks.com. A reset password link will be sent on your registered email id.
    ...
    <span>
     I agree to MagicBricks' <a href="#">Terms & Conditions.</a>
            ...
            <p>
                If you've signed up with Facebook, please visit your Facebook account to retrieve your password and login again.
