 ...
 *           &lt;element name="propertyUsers" type="{}propertyUserType" maxOccurs="unbounded" minOccurs="0"/>
 *         &lt;/choice>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
...
public class ModuleResponseType {
    ...
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2016-02-25T05:43:31+05:30", comments = "JAXB RI vhudson-jaxb-ri-2.1-833")
    protected List<PropertyUserType> propertyUsers;
    ...
    /**
     * Gets the value of the propertyUsers property.
     * 
     * <p>
     * This accessor method returns a reference to the live list,
     * not a snapshot. Therefore any modification you make to the
     * returned list will be present inside the JAXB object.
     * This is why there is not a <CODE>set</CODE> method for the propertyUsers property.
     * 
     * <p>
     * For example, to add a new item, do as follows:
     * <pre>
     *    getPropertyUsers().add(newItem);
     * </pre>
     * 
     * 
     * <p>
     ...
     */
    @Generated(value = "com.sun.tools.xjc.Driver", date = "2016-02-25T05:43:31+05:30", comments = "JAXB RI vhudson-jaxb-ri-2.1-833")
    public List<PropertyUserType> getPropertyUsers() {
        if (propertyUsers == null) {
            propertyUsers = new ArrayList<PropertyUserType>();
        }
    ...
    public void setPropertyUsers(List<PropertyUserType> value) {
        List<PropertyUserType> draftl = this.getPropertyUsers();
        draftl.addAll(value);
    }
